  ...
  ],
  {
    variants: {
      ...
      size: {
        ...
        'xs-icon': 'size-7 rounded-sm after:rounded-sm [&>svg:not([class*=size-])]:size-3.5',
        sm: 'h-8 rounded px-2.5 after:rounded [&>svg:not([class*=size-])]:size-4',
        'sm-icon': 'size-8 rounded after:rounded [&>svg:not([class*=size-])]:size-4',
        ...
        'lg-icon': 'size-11 rounded-lg after:rounded-lg [&>svg:not([class*=size-])]:size-4'
      },
      pill: {
    ...
    compoundVariants: [
      ...
      },
      {
        size: 'xs',
        progress: true,
        className: 'before:size-3.5 [&>svg]:-mr-5'
      },
      {
        size: 'sm',
        progress: true,
        className: 'before:size-4'
      }
    ],
    defaultVariants: {
      variant: 'primary',
