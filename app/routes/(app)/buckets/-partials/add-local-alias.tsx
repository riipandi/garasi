        ...
        <div className='mb-6 flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            <div className='flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-purple-100'>
              <Lucide.Key className='size-5 text-purple-600' />
            </div>
            <div>
              <h2 className='text-xl font-semibold text-gray-900'>Add Local Alias</h2>
              <p className='text-sm text-gray-600'>Add a local alias to this bucket</p>
            </div>
          </div>
          <button
            type='button'
            ...
            children={(field) => (
              <div>
                <label htmlFor='alias' className='block text-sm font-medium text-gray-700'>
                  Local Alias <span className='text-red-500'>*</span>
                </label>
                <input
                  id='alias'
                  name={field.name}
